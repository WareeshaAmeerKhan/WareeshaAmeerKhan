...
With a growing foundation in programming (**C, C++, C#, MySQL, HTML, CSS, JS, and Python**) and hands-on experience in building academic projects like **management systems** and **console-based games**, I enjoy applying theoretical concepts to real-world scenarios.  
...
## 📂 Featured Projects  
- 🐐 **Pak Animals App** – A console-based sale and purchase app in C++  
- 🎮 **Pest Shooter** – A fun console-based shooting game in C++  
- 🏢 **Event Management System** – Built using C#, WinForms, and MySQL  
...
- **LinkedIn:** [linkedin.com/in/wareesha-ameer-khan-niazi2007](https://www.linkedin.com/in/wareesha-ameer-khan-niazi2007/) 
